...
and displays them in a standard format. Each line of the file will
contain a single phone number, but hte the numbers may be in a var-
-iety mixed with other characters (which should be ignored). for 
